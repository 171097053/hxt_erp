...
public class SerialNumberService {
     ...
     * */
/*    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    public SerialNumberEx addSerialNumber(
            SerialNumberEx serialNumberEx) throws Exception{
...
/*    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
  ...
  /*  public Long checkMaterialName(String materialName)throws Exception{
     ...
     * @return Long 满足使用条件的商品的id
     */
/*    public Long getSerialNumberMaterialIdByMaterialName(
...
//            }
     ...
     */
/*    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
    public void batAddSerialNumber(String materialName,
